#!/usr/bin/env python3
"""
Merge all quant.sf files into 2 matrices (v4, fixed):
...
Fixes:
  - Deduplicate transcript IDs (unassigned_transcript_568 x2 -> second gets _dup2).
  - Fast C-level pandas to_csv (v3's pure-python row loop was too slow and got killed).
...
def main():
    ...
    # defensive: drop any duplicated index rows keeping first
